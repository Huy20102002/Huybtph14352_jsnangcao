const Header = {
   ...
   <div class="header ">
    ...
    <div class="main-header  flex pt-5 justify-around">
    <div class="logo">
    ...
    <nav>
        <ul class="flex">
            ...
            <li>
                <a class="text-slate-800 font-medium p-2 ml-4 block" href="">Tin Tức</a>
            </li>
            <li>
                <a class="text-slate-800 font-medium p-2 ml-4 block" href="">Giới Thiệu</a>
            </li>
            <li>
                <a class="text-slate-800 font-medium p-2 ml-4 block" href="">Liên Hệ</a>
            </li>
        </ul>
    </nav>
    <div class="search">

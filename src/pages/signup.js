        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" id="formsignup" >
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                    <label for="email-address" class="sr-only">User</label>
                    <input id="user" name="user" type="text"   class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                        placeholder="User......">
                    </div>
                    <div>
             ...
             <p>Bạn có tài khoản ? <a href="/signin" class = "hover:text-indigo-500 hover:underline">Đăng nhập</a></p>
              </div>
                </div>
            </form>
        </div>
